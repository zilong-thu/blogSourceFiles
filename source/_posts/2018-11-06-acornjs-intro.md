...
在我的电子书[《Web前端工程化与组件化开发实践》](/Practice-in-Front-End-Engineering-and-Components-Development/) 中，有一章专门对 JS 的解析器进行介绍，感兴趣的朋友可以移步：[JavaScript 解析器](/Practice-in-Front-End-Engineering-and-Components-Development/part-2/chapter-3-js-parsers/1-js-parser.html)。
